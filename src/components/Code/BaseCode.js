...
const baseCode = [
    ...
    },
    {
        ...
        code: <div className="javascript"><ol><li className="li1"><div className="de1"><span className="kw2">const</span> MyTimer <span className="sy0">=</span> <span className="kw2">function</span><span className="br0">&#40;</span>t<span className="sy0">,</span> s <span className="sy0">=</span> <span className="nu0">0</span><span className="br0">&#41;</span> <span className="br0">&#123;</span></div></li>
            ...
            <li className="li1"><div className="de1">&nbsp; <span className="kw1">this</span>.<span className="kw3">stop</span> <span className="sy0">=</span> s</div></li>
            <li className="li1"><div className="de1">&nbsp; </div></li>
            <li className="li2"><div className="de2">&nbsp; <span className="kw1">this</span>.<span className="me1">tick</span> <span className="sy0">=</span> <span className="br0">&#40;</span><span className="br0">&#41;</span> <span className="sy0">=&gt;</span> <span className="br0">&#123;</span></div></li>
            <li className="li1"><div className="de1">&nbsp; &nbsp;<span className="kw1">this</span>.<span className="me1">time</span> <span className="sy0">-=</span> <span className="nu0">1</span></div></li>
            ...
            <li className="li1"><div className="de1">&nbsp; <span className="br0">&#125;</span> </div></li>
            <li className="li1"><div className="de1">&nbsp; &nbsp; <span className="kw1">this</span>.<span className="me1">run</span> <span className="sy0">=</span> <span className="br0">&#40;</span><span className="br0">&#41;</span> <span className="sy0">=&gt;</span> setInterval<span className="br0">&#40;</span><span className="br0">&#40;</span><span className="br0">&#41;</span> <span className="sy0">=&gt;</span> <span className="br0">&#40;</span><span className="kw1">this</span>.<span className="me1">time</span> <span className="sy0">&lt;=</span> <span className="kw1">this</span>.<span className="kw3">stop</span><span className="br0">&#41;</span> </div></li>
            <li className="li2"><div className="de2">&nbsp; &nbsp; <span className="sy0">?</span> clearInterval<span className="br0">&#40;</span><span className="kw1">this</span>.<span className="me1">run</span><span className="br0">&#41;</span> <span className="sy0">:</span> <span className="kw1">this</span>.<span className="me1">tick</span><span className="br0">&#40;</span><span className="br0">&#41;</span><span className="sy0">,</span><span className="nu0">1000</span><span className="br0">&#41;</span></div></li>
            <li className="li1"><div className="de1">&nbsp; <span className="br0">&#125;</span></div></li>
            <li className="li1"><div className="de1">&nbsp;</div></li>
            <li className="li1"><div className="de1">let t1 <span className="sy0">=</span> &nbsp;<span className="kw2">new</span> MyTimer<span className="br0">&#40;</span><span className="nu0">10</span><span className="br0">&#41;</span></div></li>
            <li className="li1"><div className="de1">t1.<span className="me1">run</span><span className="br0">&#40;</span><span className="br0">&#41;</span></div></li>
        </ol></div>
    }
]
